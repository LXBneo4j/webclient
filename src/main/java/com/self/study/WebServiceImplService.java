 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://study.self.com/", wsdlLocation = "http://192.168.1.136:8989/Self_Service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://study.self.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.136:8989/Self_Service?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://study.self.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://study.self.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
