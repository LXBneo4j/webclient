 ...
 * generated in the com.self.study package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://study.self.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://study.self.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.self.study
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://study.self.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://study.self.com/", name = "sayResponse")
